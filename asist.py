            ...
            if len(estudiante) > 0:
                ...
                <div class="student-search-card">
                    ...
                    <div class="qr-container">
                        <img src="data:image/png;base64,{st.image(qr_bytes, use_container_width=False, width=500, output_format='png')}" style="max-width:500px; width:100%; height:auto;">
                    </div>
                    <div class="download-buttons">
                        <a href="#" class="stButton" id="download-qr-btn" style="display:inline-block;">📥 Descargar QR</a>
                        <a href="#" class="stButton" id="download-tarjeta-btn" style="display:inline-block;">📇 Descargar Tarjeta Ejecutiva</a>
                    </div>
                </div>
                """, unsafe_allow_html=True)
